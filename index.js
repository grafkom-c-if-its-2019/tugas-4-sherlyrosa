(function() {
  ...
  var cubeColors = [
    [],
    [1.0, 1.0, 1.0], // biru hijau
    [1.0, 1.0, 1.0], // hijau biru
    [1.0, 1.0, 1.0], // hijau biru
    [1.0, 1.0, 1.0], // hijau biru
    [1.0, 1.0, 1.0], // hijau biru
    [1.0, 1.0, 1.0], // hijau biru
  ...
  var verticesHuruf = new Float32Array([
    //x,y,z           //r,g,b
    0.4, 0.3,0.0, 1.0,0.0,0.0,
    0.35,0.3,0.0, 1.0,0.0,0.0,
    0.2,-0.5,0.0, 0.0,0.6,0.0,
    0.3,-0.5,0.0, 0.7,0.0,0.0,
    0.35, 0.3,0.0, 1.0,1.0,0.0,
    0.45,0.3,0.0, 0.3,1.0,0.0,
    0.5,-0.5,0.0, 0.2,0.0,0.0,
    0.6,-0.5,0.0, 1.0,1.0,0.5,
    0.45,0.3,0.0, 0.0,0.0,1.0
  ]);

  // var verticesHuruf2 = new Float32Array([
  //   //x,y,z           //r,g,b
  //         0.355,-0.05,0.0, 0.0,0.0,0.0,
  //         0.445,-0.05,0.0, 0.0,0.0,0.0,
  ...
  function render(){
    ...
    dd = glMatrix.vec3.fromValues(x_huruf, y_huruf, z_huruf);  
    gl.uniform3fv(ddLoc, dd);

    var nHuruf = initBuffers(gl,verticesHuruf);
    // var nHuruf2 = initBuffers(gl,verticesHuruf2);
    ...
    // gl.drawArrays(gl.TRIANGLE_STRIP, 0, nHuruf2);
  ...
  function draw(){
    ...
    ac = glMatrix.vec3.fromValues(0.17, 0.40, 0.18);
